...
CASE 
	...
	WHEN (	SELECT [mdb].[dbo].[prp].[value] 
			FROM [mdb].[dbo].[prp] 
			WHERE	[mdb].[dbo].[prp].[label] = '(NTAdmin/ITDeploy) OS' AND 
...
(SELECT [mdb].[dbo].[prp].[value] FROM [mdb].[dbo].[prp] WHERE ([mdb].[dbo].[prp].[label] = '(NTAdmin/ITDeploy) D: Drive Size (in GB)'  OR [mdb].[dbo].[prp].[label] = '(ITDeploy) D: Drive Size') AND [mdb].[dbo].[prp].[object_id] = [mdb].[dbo].[wf].[object_id] ) vmdisk,
'' HOST,
...
--AND (SELECT [mdb].[dbo].[prp].[value] FROM [mdb].[dbo].[prp] WHERE ([mdb].[dbo].[prp].[label] = '(ITDeploy) OS' OR [mdb].[dbo].[prp].[label] = '(NTAdmin/ITDeploy) OS') AND [mdb].[dbo].[prp].[object_id] = [mdb].[dbo].[wf].[object_id]) = 'W2K3'
--AND [mdb].[dbo].[wf].[object_id] = (SELECT [mdb].[dbo].[chg].[id] FROM [mdb].[dbo].[chg] WHERE [mdb].[dbo].[chg].[chg_ref_num] = '28125')
