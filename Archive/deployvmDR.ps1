...
#'NTEXTDC1' 'W2K3-SP1-STD-X86' '192.168.11.20' '192.168.11.200' '10.141.0.250' '2' '2048' '10' 'esxdelta05.conseco.ad' 'DeltaProd6'
...
$vmclonespec.Customization.NicSettingMap[0].Adapter.DnsServerList = "192.168.202.152", "192.168.1.3", "192.168.83.8"
...
Write-Host $vmname " deployed."

}
else
{
Write-Host "No Arguments..."
Write-Host "deploy [vmname] [osver] [foip] [fogw] [boip] [vcpus] [rammb] [ddrvgb] [vmhost] [vmdatastore]"
}