...
New-VM -VM $sourcevm -VMHost $line.hostname -Name $line.name -ResourcePool $line.rspool -Location $line.location -Datastore $line.datastore -DiskStorageFormat $line.diskstorageformat -RunAsync
}
