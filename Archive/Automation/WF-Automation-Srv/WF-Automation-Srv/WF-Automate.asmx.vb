...
<System.Web.Services.WebService(Name:="WF-Automate", Namespace:="http://wf-automate.conseco.ad/wf-automate", Description:="CNO Workflow Automation Webservice")> _
<System.Web.Services.WebServiceBinding(ConformsTo:=WsiProfiles.BasicProfile1_1)> _
<ToolboxItem(False)> _
Public Class WF_Automate
    ...
    <WebMethod()> _
    Public Function CloneVM(ByVal strVMName As String, ByVal strSourveVM As String, ByVal strFOIPAddress As String, _
                       ByVal strBOIPAddress As String, ByVal strVMdatastore As String, ByVal strVMFolder As String, _
                       ByVal strVMCluster As String, ByVal strVMResourcePool As String) As String
        Return 0
    End Function
End Class