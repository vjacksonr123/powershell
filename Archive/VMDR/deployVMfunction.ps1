...
#	}
	...
	if($dr)
	{
		Set-SQL "UPDATE dbo.NT_DRSERVERINFO SET DRTaskID = '$taskid', DRStatus = 'CLONING' WHERE Server = '$vmname'" "Server = VCENTER.CONSECO.AD; Database = VCENTER; User Id=VCAdmin; Password=vcadm6ev;"
	}
