...
#		W2K-SP4-STD-X86
#		W2K-SP4-ADV-X86
#		W2K3-R2-SP2-ENT-X64		X
#		W2K3-R2-SP2-ENT-X86		X
#		W2K3-R2-SP2-STD-X64		X
#		W2K3-R2-SP2-STD-X86		X
#		W2K3-SP1-ENT-X86		X - No Template
#		W2K3-SP1-STD-X86		X
#		W2K3-SP2-ENT-X64		X
#		W2K3-SP2-ENT-X86		X
#		W2K3-SP2-ENT-X86-NT		X
#		W2K3-SP2-STD-X86		X
#		W2K3-SP2-STD-X86-NT		X
#		W2K8-SP1-ENT-X64
#		W2K8-SP1-STD-X64
...
#	}
	...
	if($dr)
	{
		Set-SQL "UPDATE dbo.NT_DRSERVERINFO SET DRTaskID = '$taskid', DRStatus = 'CLOSUB' WHERE Server = '$vmname'" "Server = VCENTER.CONSECO.AD; Database = VCENTER; User Id=VCAdmin; Password=vcadm6ev;"
	}
