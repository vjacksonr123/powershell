...
$report | Sort-Object -Property UsageAvgMhz -Descending | Out-File c:\users\lanj6p\resultscpuR-VW4.txt
$report | Sort-Object -Property UsageAvgMhz -Descending | Export-CSV c:\users\lanj6p\resultscpuR-VW4.csv
$report | Sort-Object -Property UsageAvgMhz -Descending | Out-GridView
