...
(	SELECT [mdb].[dbo].[prp].[value] 
	...
	WHERE (	[mdb].[dbo].[prp].[label] = '(NTAdmin) Server Name' OR 
			...
			[mdb].[dbo].[prp].[label] = '(ITDeploy) Server Name'  OR 
			[mdb].[dbo].[prp].[label] = '(NTAdmin) New Server Name' ) AND 
...
(	SELECT [mdb].[dbo].[prp].[value] 
	FROM [mdb].[dbo].[prp] 
	WHERE ([mdb].[dbo].[prp].[label] = '(ITDeploy) Source Server Name' OR 
			[mdb].[dbo].[prp].[label] = '(NTAdmin/ITDeploy) Source Server Name') AND 
			[mdb].[dbo].[prp].[object_id] = [mdb].[dbo].[wf].[object_id] 
) vmsource,
...
CASE WHEN [mdb].[dbo].[wf].[description] LIKE 'Deploy VM%' THEN 'D' 
	 WHEN [mdb].[dbo].[wf].[description] LIKE 'Clone VM%' THEN 'C'
	 ELSE 'Z'
END coaction
...
AND ([mdb].[dbo].[wf].[description] LIKE 'Deploy VM%' OR [mdb].[dbo].[wf].[description] LIKE 'Clone VM%')
